...
class AboutUs: UIViewController {
    ...
    let bulletDetail1String = """
        Monitor the locations of delivery vehicles and sales personnel to optimize logistics and enhance responsiveness.\n
        """
    ...
    func setupView() {
        ...
        let bodyText1 = NSMutableAttributedString(
            string: bodyText1String, attributes: normalTextAttributes)
        ...
        let bodyText2 = NSMutableAttributedString(
            string: bodyText2String, attributes: normalTextAttributes)
        formattedAboutUsString.append(bodyText2)

        let bulletH1 = NSMutableAttributedString(
            string: boldBullet1String, attributes: boldTextAttributes)
        formattedAboutUsString.append(bulletH1)
        let bulletD1 = NSMutableAttributedString(
            string: bulletDetail1String, attributes: normalTextAttributes)
        formattedAboutUsString.append(bulletD1)

        let bulletH2 = NSMutableAttributedString(
            string: boldBullet2String, attributes: boldTextAttributes)
        formattedAboutUsString.append(bulletH2)
        let bulletD2 = NSMutableAttributedString(
            string: bulletDetail2String, attributes: normalTextAttributes)
        formattedAboutUsString.append(bulletD2)

        let bulletH3 = NSMutableAttributedString(
            string: boldBullet3String, attributes: boldTextAttributes)
        formattedAboutUsString.append(bulletH3)
        let bulletD3 = NSMutableAttributedString(
            string: bulletDetail3String, attributes: normalTextAttributes)
        formattedAboutUsString.append(bulletD3)

        let bulletH4 = NSMutableAttributedString(
            string: boldBullet4String, attributes: boldTextAttributes)
        formattedAboutUsString.append(bulletH4)
        let bulletD4 = NSMutableAttributedString(
            string: bulletDetail4String, attributes: normalTextAttributes)
        ...
        let bodyText3 = NSMutableAttributedString(
            string: bodyText3String, attributes: normalTextAttributes)
        ...
        let bodyText4 = NSMutableAttributedString(
            string: bodyText4String, attributes: normalTextAttributes)
