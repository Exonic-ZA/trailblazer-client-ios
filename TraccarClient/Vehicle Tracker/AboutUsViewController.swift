...
class AboutUsViewController: UIViewController {
    ...
    let bodyText3String = """
     ...
     Your data—whether location, device IDs, or images—is never sold to third parties for marketing or any unauthorized use. You retain full control and can disable tracking or manage your data preferences at any time through the app. For a detailed explanation of how we protect your information, please visit our 
     """
    let privacyLink = """
     Privacy Policy. 
     \n
    ...
    func setupView() {
        let tap = UITapGestureRecognizer(target: self, action: #selector(AboutUsViewController.openPrivacyPage))
        ...
        let privacyLinkText = NSMutableAttributedString(string: privacyLink, attributes: linkTextAttributes)
        formattedAboutUsString.append(privacyLinkText)
    ...
    @IBAction func openPrivacyPage(sender:UITapGestureRecognizer) {
